...
class Atividades(models.Model):
    ...
    tattica_funcionario = models.ForeignKey('TatticaFuncionarios', models.DO_NOTHING, blank=True, null=True)
    colaborador = models.ForeignKey('TatticaFuncionarios', models.DO_NOTHING, related_name='atividades_colaborador_set',
...
class ComercialProspeccao(models.Model):
    cond_nome = models.CharField(max_length=100, blank=True, null=True,
                                 db_comment='Nome do condomÝnio a qual o contato estß realizando o contato.')
    contato_nome = models.CharField(max_length=100, blank=True, null=True,
                                    db_comment='Nome do contato que fez a prospecþÒo')
    contato_telefone = models.CharField(max_length=45, blank=True, null=True,
                                        db_comment='Telefone do contato que fez a prospecþÒo.')
    contato_email = models.CharField(max_length=100, blank=True, null=True,
                                     db_comment='Email do contato a qual estß realizando a prospecþÒo.')
    contato_cargo = models.CharField(max_length=45, blank=True, null=True,
                                     db_comment='Cargo do contato no condomÝnio a qual estß realizando a prospecþÒo. ')
    contato_origem = models.CharField(max_length=45, blank=True, null=True,
                                      db_comment='Como contato ficou sabendo a respeito da Tattica.')
    cond_qtd_apt = models.IntegerField(blank=True, null=True,
                                       db_comment='Quantidade de apartamento dentro do condomÝnio a qual estß '
                                                  'realizando a prospecþÒo.')
    cond_tipo_port = models.CharField(max_length=45, blank=True, null=True,
                                      db_comment='Tipo de portaria no condomÝnio a qual estß realizando a prospecþÒo.')
    observacao = models.CharField(max_length=255, blank=True, null=True)
    status = models.IntegerField()
    created = models.DateTimeField(blank=True, null=True)
    modified = models.DateTimeField(blank=True, null=True)
...
class ControlesAcessos(models.Model):
    ...
    entregador = models.ForeignKey('TatticaFuncionarios', models.DO_NOTHING,
                                   related_name='controlesacessos_entregador_set', blank=True, null=True)
    realizador = models.ForeignKey('TatticaFuncionarios', models.DO_NOTHING,
                                   related_name='controlesacessos_realizador_set', blank=True, null=True)
    ...
    pedido = models.IntegerField(blank=True, null=True,
                                 db_comment='1 - Gratuito, 2 - Aguardando Pagamento, 6  - A receber em dinheiro, '
                                            '7 - A receber por Pagseguro, 8 - A receber por transferÛncia, '
                                            '3 - Pago em dinheiro, 5 - Pago por Pagseguro, 4 - Pago por '
                                            'transferÛncia, 9 - Em Analise')
    ...
    metodo_pagamento = models.IntegerField(blank=True, null=True,
                                           db_comment='1 - CartÒo de CrÚdito, 2 - Boleto, 3 - DÚbito, 4 - Saldo '
                                                      'PagSeguro, 5 - Oi Paggo, 7 - DÚposito em conta, 11 - PIX')
    link_boleto = models.TextField(blank=True, null=True)
    codigo_pagseguro = models.CharField(max_length=255, blank=True, null=True)
    status_pagseguro = models.IntegerField(blank=True, null=True,
                                           db_comment='1 - Aguardando Pagamento, 2 - Em analise, 3 - Paga, '
                                                      '4 - DisponÝvel, 5 - Em disputa, 6 - Devolvida, 7 - Cancelada, '
                                                      '8 - Debitado, 9 - RetenþÒo temporßria')
...
class ElevadorChamados(models.Model):
    ...
    apartamento = models.ForeignKey(Apartamentos, models.DO_NOTHING, blank=True, null=True)
    pessoa = models.ForeignKey('Pessoas', models.DO_NOTHING, blank=True, null=True)
    tattica_solicitante = models.ForeignKey('TatticaFuncionarios', models.DO_NOTHING,
                                            related_name='elevadorchamados_tattica_solicitante_set', blank=True,
                                            null=True)
...
class Ferramentas(models.Model):
    tattica_funcionario = models.ForeignKey('TatticaFuncionarios', models.DO_NOTHING, blank=True, null=True)
    tattica_supervisor = models.ForeignKey('TatticaFuncionarios', models.DO_NOTHING,
                                           related_name='ferramentas_tattica_supervisor_set', blank=True, null=True)
...
class Notificacoes(models.Model):
    user = models.ForeignKey('Users', models.DO_NOTHING)
    responsavel = models.ForeignKey('Users', models.DO_NOTHING, related_name='notificacoes_responsavel_set', blank=True,
                                    null=True)
...
class Ocorrencias(models.Model):
    ...
    condominios_funcionario = models.ForeignKey(CondominiosFuncionarios, models.DO_NOTHING, blank=True, null=True)
    tattica_solicitante = models.ForeignKey('TatticaFuncionarios', models.DO_NOTHING,
                                            related_name='ocorrencias_tattica_solicitante_set', blank=True, null=True)
    sindico = models.ForeignKey('Sindicos', models.DO_NOTHING, blank=True, null=True)
    departamento = models.ForeignKey(Departamentos, models.DO_NOTHING)
...
class Ordemdeservicos(models.Model):
    condominio = models.ForeignKey(Condominios, models.DO_NOTHING)
    tattica_funcionario = models.ForeignKey('TatticaFuncionarios', models.DO_NOTHING)
    tattica_ajudante = models.ForeignKey('TatticaFuncionarios', models.DO_NOTHING,
                                         related_name='ordemdeservicos_tattica_ajudante_set', blank=True, null=True)
...
class PlantaoOperacionals(models.Model):
    ...
    supervisor2 = models.ForeignKey('TatticaFuncionarios', models.DO_NOTHING,
                                    related_name='plantaooperacionals_supervisor2_set', blank=True, null=True)
...
class Portas(models.Model):
    ...
    tag_dispositivo = models.ForeignKey(DispositivosModelos, models.DO_NOTHING,
                                        related_name='portas_tag_dispositivo_set', blank=True, null=True)
    bio_dispositivo = models.ForeignKey(DispositivosModelos, models.DO_NOTHING,
                                        related_name='portas_bio_dispositivo_set', blank=True, null=True)
    ctrlgar_dispositivo = models.ForeignKey(DispositivosModelos, models.DO_NOTHING,
                                            related_name='portas_ctrlgar_dispositivo_set', blank=True, null=True)
...
class TiposAbastecimentos(models.Model):
    ...
    created = models.DateTimeField(blank=True, null=True)
    modified = models.DateTimeField(blank=True, null=True)
    subtipos_tipos_abastecimentos = models.ForeignKey(SubtiposTiposAbastecimentos, models.DO_NOTHING, blank=True,
                                                      null=True)
